#Bike Demand Prediction in Hourly dataset
#
#Prerequirement:
#-Knowledge of python
#-Statistics
#-Data Processing
#-Multilinear Regression (Ml_Algorithm)
...
#---------------------------------------------
# Step2=[Prelim_Analysis&Feature_Selection]-
#---------------------------------------------
...
#-[ simple visualization  of a data using Pandas ]-
...
# Visualization the Catagorical Feature
colors=["g","r","m","b"]
plt.subplot(3,3,1)
...
# linearity using correlation coefficient using corr
correlation = bikes_prep[["temp","atemp","humidity","windspeed","demand"]].corr()

#drop irrevant featuers
bikes_prep = bikes_prep.drop(["weekday","year","workingday","atemp","windspeed"],axis=1)

#Check autocorrelation in demand using acorr float
